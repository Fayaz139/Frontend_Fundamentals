...
btns[0].classList.add("border-indigo-500", "bg-indigo-100", "border-2", "text-indigo-500")
...
for (let i = 0; i < btns.length; i++) {
    btns[i].addEventListener("click", (e) => {
        for (let j = 0; j < btns.length; j++) {
            btns[j].classList.remove("border-indigo-500", "bg-indigo-100", "border-2", "text-indigo-500")
        }
        e.target.classList.add("border-indigo-500", "bg-indigo-100", "border-2", "text-indigo-500")
